...
//                                    .build())
    ...
    public ContaDTO depositar(ContaTransactionsDTO dto) {
    	
    	Conta c = this.repository.acharContasPorNumContaENumAgencia(dto.getNumConta(), dto.getNumAgencia());
    ...
    public ContaDTO sacar(ContaTransactionsDTO dto) {
    ...
    public ContaDTO transferir(ContaTransferDTO dto) {
    	
    	Conta cOrigem = this.repository.acharContasPorNumContaENumAgencia(dto.getNumContaOrigem(), dto.getNumAgenciaOrigem());
    	Conta cDestino = this.repository.acharContasPorNumContaENumAgencia(dto.getNumContaDestino(), dto.getNumAgenciaDestino());
    	
    	cOrigem.setSaldo(cOrigem.getSaldo() - dto.getValor());
    	cDestino.setSaldo(cDestino.getSaldo() + dto.getValor());
    	
    	this.repository.save(cOrigem);
    	this.repository.save(cDestino);
    	
    	return toDTO(cOrigem);
    }
